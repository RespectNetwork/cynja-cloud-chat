...
public class ConnectionServiceImpl implements ConnectionService{
	...
	public Connection requestConnection(XDIAddress cloud1, String cloud1SecretToken, XDIAddress cloud2){
		...
		try {
			...
			XDIDiscoveryResult cloud1Discovery = InitFilter.XDI_DISCOVERY_CLIENT.discoverFromRegistry(cloud1);
			...
			XDIDiscoveryResult cloud2Discovery = InitFilter.XDI_DISCOVERY_CLIENT.discoverFromRegistry(cloud2);
			...
			PrivateKey cloud1PrivateKey = XDIClientUtil.retrieveSignaturePrivateKey(cloud1Discovery.getCloudNumber(), cloud1Discovery.getXdiEndpointUri(), cloud1SecretToken);
	...
	public Connection approveConnection(XDIAddress cloud, String cloudSecretToken, XDIAddress cloud1, XDIAddress cloud2){	
		...
		try {
			...
			XDIDiscoveryResult approverDiscovery = InitFilter.XDI_DISCOVERY_CLIENT.discoverFromRegistry(cloud);
			...
			PrivateKey approverPrivateKey = XDIClientUtil.retrieveSignaturePrivateKey(approverDiscovery.getCloudNumber(), approverDiscovery.getXdiEndpointUri(), cloudSecretToken);
	...
	public Connection[] viewConnectionsAsParent(XDIAddress parent, String parentSecretToken){
		...
		try {
			...
			PrivateKey parentPrivateKey = XDIClientUtil.retrieveSignaturePrivateKey(parentDiscovery.getCloudNumber(), parentDiscovery.getXdiEndpointUri(), parentSecretToken);
	...
	public Connection[] viewConnectionsAsChild(XDIAddress cloud, String cloudSecretToken){
		...
		try {
			...
			XDIDiscoveryResult cloudDiscovery = InitFilter.XDI_DISCOVERY_CLIENT.discoverFromRegistry(cloud);
